...
The program does not have any kind of exception handling. When error has happened, it gives little information about it and/or allows the program to continue running nevertheless.

## PoC

At login, wrong credentials are informed. Images files can be added without any notice whether or not it is a suitable file. Student can be added into the database with erroneous information. 

## Impact

Critical error can happen, without the user necessarily noticing it, or be made aware of it.

## Remediation

Error messages should be given on any error happening, to further enhance the user experience and security.
